...
SECRET_KEY = 'django-insecure-icclh657flx&*sgq1(2$t1&-f@cva1so1)ee-2k%4b)ka8p3%i'
...
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"   # output to console now